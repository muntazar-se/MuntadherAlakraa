...
Muntadher Al-Akraa
  ...
  <div className="contact-icons flex flex-row gap-4">
    {[
      { href: "https://www.linkedin.com/in/your-username", icon: "FaLinkedin" },
      { href: "mailto:muntadher.alakraa@gmail.com", icon: "FaEnvelope" },
      { href: "https://twitter.com/your-username", icon: "FaXTwitter" }
    ].map((link, index) => (
      <motion.a
        key={index}
        href={link.href}
      ...
      >
        ...
        {link.icon === "FaLinkedin" && (
          ...
          >
            <FaLinkedin size={20} className="text-gray-200 transition-all duration-300 group-hover:text-blue-400" />
          </motion.div>
        )}
        {link.icon === "FaEnvelope" && (
          <motion.div
            ...
            transition={{ duration: 0.2, type: "spring" }}
          >
            <FaEnvelope size={20} className="text-gray-200 transition-all duration-300 group-hover:text-purple-400" />
          </motion.div>
        )}
        {link.icon === "FaXTwitter" && (
          <motion.div
            ...
            transition={{ duration: 0.2, type: "spring" }}
          >
            <FaXTwitter size={20} className="text-gray-200 transition-all duration-300 group-hover:text-blue-300" />
          </motion.div>
        )}
      </motion.a>
    ))}
          ...
          lg:flex lg:flex-col lg:gap-10 lg:justify-start lg:items-start">
            ...
            <motion.p
              ...
              >
                ...
                <span className="text-my1-gradient">DNA</span>. I have worked on
                full-stack web applications using React, Node.js, and MongoDB. I
                focus on building intuitive and efficient solutions that bridge
  ...
  style={{
    background: "linear-gradient(270deg, #13ADC7, #6978D1, #945DD6) border-box",
  }}
>
  ...
  Download CV
          ...
          <div
            className="circles relative lg:h-full lg:w-fit lg:-left-30"
          >
            <motion.div
    ...
    {[
      {
        ...
        title: "Balsam",
        description: "Doctor appointment booking platform, Responsive HTML/CSS layout for online furniture store. HTML5, CSS3 (SCSS)"
      },
      {
        image: "./plane-scape.png",
        title: "Plane Escape",
        description: "Flight booking App, Responsive HTML/CSS layout for online furniture store. HTML5, CSS3 (SCSS)"
      },
      {
        image: "./project-image.png", 
        title: "Balsam",
          ...
          >
            ...
            >
              ...
              <motion.div
                ...
                transition={{ duration: 0.5 }}
              >
                <FaGithub size={30} color="white" className="group-hover:text-blue-400 transition-colors duration-300" />
              </motion.div>
            </motion.div>
          </motion.div>
        </motion.div>
  ...
  >
    ...
    >
      ...
      View More Projects
        ...
        <div className="contact flex justify-center mt-15 flex-col 
        lg:mt-1
        ">
